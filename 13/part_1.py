...
test_track = read_file('test_track.txt')
test_track2 = read_file('test_track2.txt')
track = read_file('input.txt')

assert run_carts(test_track) == (7, 3)
assert run_carts(test_track2) == (7, 0)
